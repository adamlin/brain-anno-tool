<?php
    ...
    if ($result = mysqli_query($con, $sql)) {
       while($row = mysqli_fetch_array($result)) {
            ...
            echo '<a href="/annotation_tool/ol_cshl_anno.html?brain_id='.$brain_id.'&label='.$label.'&pid='.$dect_num.'&color='.$color.'">';
            ...
            echo '            <img class="lazy-load bottom-filmstrip" src="'.$hostname.$improve_image.'" alt="Section r3b" width="120"/>';
            if ($label == 'F'){
