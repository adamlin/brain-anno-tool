...
$(function() {
    ...
    function trigerIIIF(url, zoomurl){
        $.getJSON(url, function (data) {
            ...
            app.annotation_features = new ol.Collection();
            ...
            app.overlay_layer = overlay_layer;
            app.vector_edit.setOpacity(0.1);
            ...
            function save_data(stat_comp){
                ...
                if (stat_comp == 0){
                    ...
                    $.ajax({
                        type : "POST",
                        url  : "/openlayers/postnewcellcounts_mri.php",
                        data: {'qry' :regquery1},
            ...
            function getDeleteID(){
                ...
                $.ajax({
                    type : "POST",
                    url  : "/openlayers/postdeletcellcounts_mri.php",
                    data: {'qry' :regquery},
                    async: false,
                    success :function(result){
                        returnvalue = result;
            ...
            function getAddedID(){
                ...
                $.ajax({
                    type : "POST",
                    url  : "/openlayers/postaddcellcounts_mri.php",
                    data: {'qry' :regquery},
                    async: false,
                    success :function(result){
                        if(result =='s'){
    ...
    $(document).ready(function(){
        trigerIIIF(app.url2, app.zoomurl);
    });
});
