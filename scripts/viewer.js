...
*/
    ...
    jsrc.getImageMetadata(function() {
        ...
        */
        ...
        var formatLength = function(line) { // due to convertion with 1:2:end or 1:3:end
          if(label == 'F'){
            if(brain_id == '819' || brain_id == '820' || brain_id == '822' || brain_id == '823' || brain_id == '919'){
                var length = Math.round(line.getLength() * 100) / 100; //Math.round(line.getLength() * 100) / 100 / 2;
            }else{
                var length = Math.round(line.getLength() * 100) / 100 / 2 * 3; //Math.round(line.getLength() * 100) / 100 / 2;
            }
