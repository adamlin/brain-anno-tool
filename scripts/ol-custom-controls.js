...
app.SagittalNav = function(opt_options) {
    ...
    if(label == 'mri'){
        img.src = '/openlayers/images/atlas_labels_contours_saggital_2016_revise.png';
    }
    else{
        $.ajax({
            url:'/openlayers/getsegnavnav.php',
            type: 'POST',
            //contentType:'application/json; charset = utf-8',
            data: {'qry' :injectquery},
            	success:function(result){
                    img.src = '/openlayers/images/atlas_labels_contours_saggital_2016.png';
        //     		if(result < -7){
        //     			img.src = '/openlayers/images/atlas_labels_contours_saggital_12.png';
        //     		}else if(result >= -7 && result < -6){
        //     			img.src = '/openlayers/images/atlas_labels_contours_saggital_11.png';
        //     		}else if(result >= -6 && result < -5){
        //     			img.src = '/openlayers/images/atlas_labels_contours_saggital_10.png';
        //     		}else if(result >= -5 && result < -4){
        //     			img.src = '/openlayers/images/atlas_labels_contours_saggital_09.png';
        //     		}else if(result >= -4 && result < -3){
        //     			img.src = '/openlayers/images/atlas_labels_contours_saggital_08.png';
        //     		}else if (result >= -3 && result < -1){
        //     			img.src = '/openlayers/images/atlas_labels_contours_saggital_07.png';
        //     		}else if(result >= -1 && result < 1){
        //     			img.src = '/openlayers/images/atlas_labels_contours_saggital_06.png';
        //     		}else if(result >= 1 && result < 3){
        //     			img.src = '/openlayers/images/atlas_labels_contours_saggital_05.png';
        //     		}else if (result >= 3 && result < 5){
        //     			img.src = '/openlayers/images/atlas_labels_contours_saggital_04.png';
        //     		}else if (result >= 5 && result < 7){
        //     			img.src = '/openlayers/images/atlas_labels_contours_saggital_03.png';
        //     		}else if (result >= 7 && result < 9){
        //     			img.src = '/openlayers/images/atlas_labels_contours_saggital_02.png';
        //     		}else if (result >= 9 ){
        //     			img.src = '/openlayers/images/atlas_labels_contours_saggital_01.png';
        //     		}     
        //     		console.info(result);
        //     		if(result == ''){
    				// 	img.src = '/openlayers/images/atlas_labels_contours_saggital_2016.png';
...
*/
    ...
    var sagittalNav = function(e) {	
    	...
    	if(label == 'mri'){
           if (this.x){
                regquery = '{"brainno":"'+ br_no + '","label":"'+ slice_type + '","curent_file":"'+ pid + '","filelocation":"'+file_location+ '","index":"'+ Math.round((this.x)*1) + '"}';
                console.log(regquery);
 
                $.ajax({
                    url:'/openlayers/getsegnavlink_mri.php',
                    type: 'POST',
                    //contentType:'application/json; charset = utf-8',
                    data: {'qry' :regquery},
                        success:function(result){
                            console.info(result);
                            window.location.href = '/openlayers/ol_mri.html?'+result;               
                    }
                });
            }            
        }
            ...
            if (this.x){
    		    ...
    		    $.ajax({
                    url:'/openlayers/getsegnavlink.php',
                    type: 'POST',
                    //contentType:'application/json; charset = utf-8',
                    data: {'qry' :regquery},
                    	success:function(result){
                            var baseUrl = getUrl.pathname.split('/')[2];
                            if (baseUrl == 'ol5.html'){
                                window.location.href = '/openlayers/ol5.html?'+result;       
                            }
                            else if (baseUrl == 'ol8.html'){
                                window.location.href = '/openlayers/ol8.html?'+result;  
                            }
                            else if (baseUrl == 'ol4_cross.html'){
                                window.location.href = '/openlayers/ol4_cross.html?'+result;  
                            }
                            else{
                    	       window.location.href = '/openlayers/ol4.html?'+result; 
                            }              
                    }
                });
            }
